    ...
    XMFLOAT3 cameraPosition)
{
    ...
    result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, textures[0], ShaderClass::m_Light->GetDirection(), ShaderClass::m_Light->GetAmbientColor(), ShaderClass::m_Light->GetDiffuseColor(), m_clipPlane);
    if (!result)
    {
        return false;
    }
